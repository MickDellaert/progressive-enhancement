...
Exercise to further enhance our knowledge in HTML and CSS.
* Understanding the importance of semantics
* Researching the origins of HTML tags
* Structuring the page with appropriate sections and tags
* Understanding the importance of the structure: accessibility and search engine optimization

* Building a layout with appropriate HTML tags and structured CSS
* Understanding the CSS box model
* Styling with CSS

Have a glimpse at the result over here:
